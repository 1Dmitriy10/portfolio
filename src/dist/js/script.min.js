...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   getForm: () => (/* binding */ getForm)\n/* harmony export */ });\nfunction getForm() {\r\n    let form = document.querySelector(\".form\")\r\n    form.addEventListener(\"submit\", goForm)\r\n    async function goForm(e) {\r\n        e.preventDefault()\r\n        let formData = new FormData(form)\r\n        console.log(formData)\r\n        let response = await fetch('sendmail.php', {\r\n            method: 'POST',\r\n            body: formData\r\n        });\r\n    }\r\n}\r\ngetForm()\n\n//# sourceURL=webpack://testgulp/./src/js/email.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _burgerMenu_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./burgerMenu.js */ \"./src/js/burgerMenu.js\");\n/* harmony import */ var _scroll_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scroll.js */ \"./src/js/scroll.js\");\n/* harmony import */ var _animationBgBlue_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./animationBgBlue.js */ \"./src/js/animationBgBlue.js\");\n/* harmony import */ var _slider_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./slider.js */ \"./src/js/slider.js\");\n/* harmony import */ var _minimizeImg_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./minimizeImg.js */ \"./src/js/minimizeImg.js\");\n/* harmony import */ var _animationPortfolio_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./animationPortfolio.js */ \"./src/js/animationPortfolio.js\");\n/* harmony import */ var _scrolAnim_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./scrolAnim.js */ \"./src/js/scrolAnim.js\");\n/* harmony import */ var _email_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./email.js */ \"./src/js/email.js\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\n\n//# sourceURL=webpack://testgulp/./src/js/main.js?");

/***/ }),

/***/ "./src/js/minimizeImg.js":
/*!*******************************!*\
  !*** ./src/js/minimizeImg.js ***!
  \*******************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   getMinimize: () => (/* binding */ getMinimize)\n/* harmony export */ });\nfunction getMinimize() {\r\n    const exitImg = document.querySelectorAll(\".img-exit\")\r\n    const img = document.querySelectorAll(\".minimize\")\r\n    const popupBg = document.querySelector(\".popup-bg\")\r\n    const body = document.querySelector(\"body\")\r\n    const container = document.querySelector(\".popup-wrap\")\r\n    let count = 1;\r\n    for (const el of img) {\r\n        el.id = count\r\n        el.addEventListener(\"click\", toggleActiveClass)\r\n        count++\r\n    }\r\n    for (const el of exitImg) {\r\n        el.addEventListener(\"click\", toggleActiveClass)\r\n    }\r\n    function toggleActiveClass(ev) {\r\n        for (const el of img) {\r\n            if (el.id === ev.target.id) {\r\n                ev.preventDefault();\r\n                popupBg.classList.toggle(\"active\");\r\n                body.style.cssText = `overflow: hidden;`\r\n                container.innerHTML = ''\r\n                container.insertAdjacentHTML(\"beforeend\", `\r\n                <img class=\"bigImg\"\r\n                            src=\"${el.src}\" alt=\"\">`)\r\n            }\r\n        }\r\n        for (const el of exitImg) {\r\n            if (el.id === ev.target.id) {\r\n                ev.preventDefault();\r\n                popupBg.classList.toggle(\"active\");\r\n                body.style.cssText = `overflow: auto;`\r\n            }\r\n        }\r\n    }\r\n}\r\ngetMinimize()\n\n//# sourceURL=webpack://testgulp/./src/js/minimizeImg.js?");
